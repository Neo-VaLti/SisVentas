    ...
    public class DCliente
    {
        ...
        public string Insertar(DCliente Cliente)
        {
            ...
            try
            {
                ...
                ParNum1_Documento.Value = Cliente.Num_Documento;
