...
{
    public partial class frmPrincipa1 : Form
    {
        ...
        private void frmPrincipa1_Load(object sender, EventArgs e)
        {
            GestionUsuario();
        }
        ...
        private void GestionUsuario()
        {
            ...
            if (Acceso == "Administrador")
            {
                ...
                this.MnuManteniminto.Enabled = true;
            ...
            else if (Acceso == "Vendedor")
            {
                ...
                this.TsVentas.Enabled = true;
                this.MnuManteniminto.Enabled = false;
            }
